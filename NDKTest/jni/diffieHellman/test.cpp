...
#include "diffieHellman/test.h"

JNIEXPORT jstring JNICALL Java_pl_ndk_ndktest_MainActivity_invokeNativeFunction(JNIEnv* env, jobject javaThis)
{
	...
	{
		cerr << e.what() << endl;
		return env->NewStringUTF("Hello from native code!-2");;
	}

	catch(const std::exception& e)
	{
		cerr << e.what() << endl;
		return env->NewStringUTF("Hello from native code!-1");;
	}

	return env->NewStringUTF("Hello from native code!23232323");
}
